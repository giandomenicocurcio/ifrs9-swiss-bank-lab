...
FROM
    public.accounts
JOIN risk.exposure_snapshot
ON risk.exposure_snapshot.exposure_amount = public.accounts.balance;
...
FROM
    core.accounts a
JOIN risk.exposure_snapshot e
ON e.exposure_amount = a.balance;
...
I understand that I am asking all columns from table public.customers, Correct?
But if I write:
SELECT
    a.customer_name,
    a.customer_id,
...
and forget for now about what there is after FROM
I need to understand why after FROM there is a and not b, the answer is that 
